        ...
        <div className="space-y-8 bg-secondary border border-theme p-8 rounded-[32px]">
          ...
          <div className="space-y-4 pt-6 border-t border-theme">
            <div className="grid grid-cols-1 gap-4">
              <input
                type="text"
                placeholder="Project Topic / Main Objective"
                className="w-full bg-primary border border-theme p-4 rounded-xl text-sm focus:border-purple-500 outline-none text-primary"
                value={topic}
              ...
              <input
                type="date"
                className="w-full bg-primary border border-theme p-4 rounded-xl text-sm text-secondary focus:border-purple-500 outline-none [color-scheme:dark]"
                value={deadline}
            ...
            <textarea
              ...
              className="w-full bg-primary border border-theme p-4 rounded-xl text-sm focus:border-purple-500 outline-none resize-none h-32 text-primary"
              value={instructions}
