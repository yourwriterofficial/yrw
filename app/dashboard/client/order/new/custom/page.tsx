          ...
          <div className="space-y-4 pt-6 border-t border-zinc-800">
            <div className="grid grid-cols-1 gap-4">
              <input
                ...
                className="w-full bg-[#0f0f0f] border border-zinc-800 p-4 rounded-xl text-sm focus:border-purple-500 outline-none"
                value={topic}
              ...
              <input
                type="date"
                className="w-full bg-[#0f0f0f] border border-zinc-800 p-4 rounded-xl text-sm text-zinc-400 focus:border-purple-500 outline-none [color-scheme:dark]"
                value={deadline}
