...
import { GraduationCap, PenTool, Terminal, Briefcase, LineChart } from 'lucide-react';
...
export default function OrderCategoryNav() {
  ...
  const categories: Category[] = [
    ...
    { id: 'statistics', label: 'Statistics', path: '/statistics', color: 'text-purple-500 border-purple-500/30 bg-purple-500/5', inactiveColor: 'hover:text-purple-400 hover:bg-purple-500/5', icon: <LineChart className="w-4 h-4 text-purple-500" /> },
  ];
