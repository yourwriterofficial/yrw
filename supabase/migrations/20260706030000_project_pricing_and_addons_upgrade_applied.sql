-- NOTE: this file mirrors 20260706010000_project_pricing_and_addons_upgrade.sql,
-- which existed in the repo but had never actually been applied to the live
-- database — project_settings, the addon columns, and the randomize RPC were
-- all missing in production, which is what broke addon editing and reload
-- randomization. Re-applying here (idempotent) so the migration history
